...
public class Comilla extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Comilla.this,ProfileActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.comilla, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_name) {
            double newLat = 23.461691;
            double newLong = 91.185345;
            ...
            Intent i = new Intent(Comilla.this, MapsActivity.class);
            i.putExtras(args);
            startActivity(i);
        }
