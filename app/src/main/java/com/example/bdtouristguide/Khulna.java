...
public class Khulna extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Khulna.this,ProfileActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.khulna, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_name) {
            double newLat = 22.847185;
            double newLong = 89.537305;
            ...
            Intent i = new Intent(Khulna.this, MapsActivity.class);
            i.putExtras(args);
            startActivity(i);
        }
