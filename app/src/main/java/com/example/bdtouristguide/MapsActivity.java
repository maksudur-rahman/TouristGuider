...
public class MapsActivity extends FragmentActivity implements OnStreetViewPanoramaReadyCallback,OnMapReadyCallback,
    ...
    public void onLocationChanged(Location location) {
        ...
        if (i != null && ll != null)
        {
            ...
            m.setPosition(new LatLng(ll.latitude, ll.longitude));
        }
