...
public class Mymensingh extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Mymensingh.this,ProfileActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.mymensingh, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_name) {
            double newLat = 24.745361;
            double newLong = 90.399369;
            ...
            Intent i = new Intent(Mymensingh.this, MapsActivity.class);
            i.putExtras(args);
            startActivity(i);
        }
