...
public class Rangpur extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Rangpur.this,ProfileActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.rangpur, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_name) {
            double newLat = 25.828377;
            double newLong = 89.254260;
            ...
            Intent i = new Intent(Rangpur.this, MapsActivity.class);
            i.putExtras(args);
            startActivity(i);
        }
